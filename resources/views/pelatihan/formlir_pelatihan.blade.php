          ...
          <div class="col-lg-9">
            <div class="form-group input">
             <label for="nama" class="control-label">Nama</label>
              <input type="text" name="{{$platihan}}-nama" id="inputnama" placeholder="Isi nama lengkap dan gelar" class="form-control" autocomplete="off">
            </div>
          </div>
          ...
          <div class="col-lg-9">
            <div class="form-group input">
             <label for="nip" class="control-label" >Nama Perusahaan</label>
              <input type="text" name="{{$platihan}}-nama_perusahaan" id="nama_perusahaan" placeholder="Isikan Nama Perusahaan dengan benar" class="form-control" autocomplete="off">
            </div>
          </div>
          ...
          <div class="col-lg-9">
            <div class="form-group input">
             <label for="alamat" class="control-label">Alamat</label>
              <textarea name="{{$platihan}}-alamat" id="inputalamat" class="form-control" placeholder="Isikan Alamaat" rows="4"></textarea>
            </div>
          </div>
             ...
             <label for="no_hp" class="control-label">No Handphone</label>
              <div class="input-group">
                <div class="input-group-addon">
                  ...
                  <input type="text" name="{{$platihan}}-no_hp" id="inputno_hp" class="form-control" placeholder="Contoh: +6281232456790" autocomplete="off">
              </div>
            </div>
          </div>
            ...
            <div class="form-group input">
             <label for="email" class="control-label">Email</label>
              <div class="input-group">
                ...
                <input type="text" name="{{$platihan}}-email" id="inputemail" class="form-control" placeholder="Contoh: contoh@gmail.com" autocomplete="off">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="form-group input">
             ...
             <div class="input-group col-sm-5">
                <select name="{{$platihan}}-tanggal_pelatihan" class="form-control">
